...
2. While running, do not leave or refresh page. If connection is resetted for some reason, you can resume index creation: previous API requests are cached and will be faster to process.
